...
CREATE TABLE public.llms (
    ...
    structured_content integer DEFAULT 0 NOT NULL,
    embeddings integer DEFAULT 0 NOT NULL,
...
ALTER TABLE public.llms OWNER TO supabase_admin;

ALTER TABLE public.llms ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.llms_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TRIGGER update_llms_updated_at BEFORE UPDATE ON public.llms FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
GRANT ALL ON TABLE public.llms TO postgres;
GRANT ALL ON TABLE public.llms TO anon;
GRANT ALL ON TABLE public.llms TO authenticated;
GRANT ALL ON TABLE public.llms TO service_role;

GRANT ALL ON SEQUENCE public.llms_id_seq TO postgres;
GRANT ALL ON SEQUENCE public.llms_id_seq TO anon;
GRANT ALL ON SEQUENCE public.llms_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.llms_id_seq TO service_role;
