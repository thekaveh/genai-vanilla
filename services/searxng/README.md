...
| Path | URL | Notes |
|---|---|---|
| Direct | `http://localhost:${SEARXNG_PORT}` (default `63014`) | Web UI + `/search` API. |
...
SEARXNG_PORT=63014                   # computed by topology.py
SEARXNG_SECRET=                      # auto-generated by bootstrapper; rotate by clearing + restart
SEARXNG_PUBLIC_INSTANCE=false        # leave false unless you intend a public-internet endpoint
