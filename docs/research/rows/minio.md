...
- **Prometheus metrics endpoint** — Why pursue: MinIO exposes `/minio/v2/metrics/cluster`; no observability service consumes it yet, but it's the natural feeder if a metrics stack lands. Effort: small.
